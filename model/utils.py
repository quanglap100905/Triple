...
def load_data(args):
    train_tsv = "IJCAI2019_data/twitter2015/train.tsv".replace('twitter2015', args.dataset)
    dev_tsv = "IJCAI2019_data/twitter2015/dev.tsv".replace('twitter2015', args.dataset)
    test_tsv = "IJCAI2019_data/twitter2015/test.tsv".replace('twitter2015', args.dataset)
    image_path = "IJCAI2019_data/twitter2015_images".replace('twitter2015', args.dataset)
    captions_json = "IJCAI2019_data/captions/twitter2015_images.json".replace('twitter2015', args.dataset)
